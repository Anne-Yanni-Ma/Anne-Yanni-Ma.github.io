...
def process_onescan(relationships_scan):
    ...
    file_MLC = open(os.path.join('/home/ma/myn/2023/KISGP_MLC/data/classes_MLC.txt'), 'r')
...
def write_into_json(relationship, dataset_type):
    ...
    np.save(gt_obj_MLC_path, np_gt_obj_MLC)
